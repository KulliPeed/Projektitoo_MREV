...
|---------|------|--------------|------|
| EMTA maksuvõla avaandmed 
(https://ncfailid.emta.ee/s/XKJLjtynFeYdGyC/download/maksuvolglaste_nimekiri.csv) | CSV / XLSX | Jah, iga päev | sisend ettevõtete maksuvõla olemasolu ja selle vanuse tuvastamisel |
